...
function Book(title,genre,description,author,pictureUrl,releaseDate,pages) {
  // the constructor..
  if (!new.target){
...
function addBookToLibrary(title,genre,description,author,pictureUrl,releaseDate,pages) {
  // take params, create a book then a store it in the array
  const book = new Book(title,genre,description,author,pictureUrl,releaseDate,pages);
